...
public class Time {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Initial time: %s %s %n", myTime.toUniString(), 
                myTime.toString());
        ...
        System.out.printf("After setting time: %s %s %n", myTime.toUniString(), 
                myTime.toString());
        ...
        System.out.printf("Time1 generated using full constructor: %n %s %s %n",
                allThree.toUniString(), allThree.toString());
        
        Time hourAndMin = new Time(13, 55);
        System.out.printf("Time2 generated using hour and minute constructor: "
              + "%n %s %s %n", hourAndMin.toUniString(), hourAndMin.toString());

        Time justHour = new Time(13);
        System.out.printf("Time3 generated using just hour constructor: "
              + "%n %s %s %n", justHour.toUniString(), justHour.toString());
        
        Time copyTime = new Time(allThree);
        System.out.printf("Time generated using copy constructor: %n %s %s %n", 
                copyTime.toUniString(), copyTime.toString());
